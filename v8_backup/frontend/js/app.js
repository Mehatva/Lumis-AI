...
const App = {
  ...
  async onboardCreateBusiness(e) {
    ...
    if (result && !result.error) {
      ...
      // 2. Reveal and scroll to pricing section
      const pricingSection = document.getElementById("pricing-section");
      if (pricingSection) {
        pricingSection.classList.remove("hidden");
        // Update CTA container to hidden just in case
        const cta = document.getElementById("setup-cta-container");
      ...
      Toast.show("Brand identity saved! ✨ Choose your plan below.", "success");
    } else {
